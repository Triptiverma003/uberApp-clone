         ...
         const submitHandler = async(e) =>{
            ...
            return (
                <div className='p-7 h-screen flex flex-col justify-between'>
                    ...
                    <div className='flex gap-4 mb-5'>
                        <input 
                            className='bg-[#eeee] rounded px-4 border text-lg placeholder:text-base w-1/2'
                            required type='text' 
                    ...
                    <button className='bg-black text-white font-semibold mb-3 px-4 rounded py-2 w-full text-lg placeholder:text-sm'>Register as a captain</button>
